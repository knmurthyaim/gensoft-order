  ...
  return (
    <div>
      ...
      <UploadSection
        ...
        description={
          "Invoice-wise outstanding. Put invoice_date as Excel Date or DD-MM-YYYY " +
          "(or INVOICE_DA from VFP). Age is calculated automatically from invoice_date. " +
          "Discount column is treated as % (not amount)."
        }
        api={outstanding}
        resultLabel="Bills"
      />
