    ...
    rows: [
      {
        ...
        yesHelp:
          "Yes: Rep phone saves GPS (30s check, 50m+ moves) on the device first, then uploads when online — even without opening the screen again if the GenSoft app is still running / installed as Android app. Visible only to you for 7 days.",
        noHelp:
