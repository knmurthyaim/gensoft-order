    ...
    rows: [
      {
        ...
        yesHelp:
          "Yes: Rep phone checks GPS every 30 seconds. Saves only if moved 50m+. Offline points upload when the app opens or network returns. Visible only to you for 7 days.",
        noHelp:
